    ...
    <div className='w-full select-none mb-4 bg-[#e3f1ff] rounded-lg'>
        <div className='md:p-6 p-4'>
            <div onClick={onClick} className='flex cursor-pointer items-center justify-between gap-[24px]'>
                ...
                <span className='p-1'>
                    {
                        open ? (<FiMinus className='md:w-[24px] md:h-[24px] w-[20px] h-[20px]'/>) : (<FaPlus className='md:w-[24px] md:h-[24px] w-[20px] h-[20px]'/>)
                    }      
                </span>
            </div>
            {open && (<p className='md:text-[18px] text-[16px] text-[#36485c] mt-4'>{children}</p>)}
        </div>
    </div>
  )
}
