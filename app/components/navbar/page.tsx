...
import User from '@/public/Images/Navbar/User_Navbar.svg'
  ...
  return (
    <section className='w-full flex justify-center'>
        <div className='lg:mx-20 mx-5 max-w-[1536px] w-full my-6 flex'>
            <div>
                <Image src={Logo} alt='logo' width={0} height={0} className='lg:w-[35px] lg:h-[35px] w-[45px] h-[45px]' />
            </div>
            <div className='flex lg:justify-between w-full justify-end'>
                ...
                <div className='my-auto flex'>
                    ...
                    <span className='flex cursor-pointer'>
                        <Image src={User} alt='user picture' className='lg:w-[26px] lg:h-[26px] h-[32px] w-[32px] mr-3' width={0} height={0} />
                        <span className='font-medium text-[#36485c] lg:block hidden'>Sign In</span>
                    </span>
